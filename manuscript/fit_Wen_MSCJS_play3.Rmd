...
*Data availability statement*: All data were downloaded from public repositories cited within the manuscript. All data and code used in the analysis analysis are available at  https://github.com/marksorel8/Wenatchee-survival
...
```{r data_load, message=FALSE, warning=FALSE, process_dat,echo=FALSE,cache=FALSE}
