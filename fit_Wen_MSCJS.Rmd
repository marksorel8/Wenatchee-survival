...
time1:streamWhite:LHsmolt+time1:streamWhite:LHfall+ 
                         ...
                         doFit = TRUE,silent=TRUE,
                         sim_rand =0,REML=FALSE,hypersd = 1,map_hypers=c(FALSE,FALSE)
)
...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                            ...
                            ## to McNary
                            time2+ pc(0+time2|age_class) + pc(0+time2 |mig_year)+ 
                            ##to Bonneville
                            time3 + pc(0+time3|age_class) + pc(0+time3|mig_year)+
                          ...
                          p_formula= par.index~
                            ...
                            time3+ pc(0+time3|age_class) + pc(0+time3 |mig_year)+
                            # Bonneville Juvenile
                            time4+ pc(0+time4|age_class) +pc(0+time4:McN_J:age_class|one) + pc(0+time4 |mig_year) + 
                            # Bonn adult
                            time5 + pc(0+time5 |mig_year)+ pc(0+time5|stratum ) +
                            #McNary adult
                            time6 + pc(0+time6 |mig_year)+ pc(0+time6|stratum )
                          ...
                          psi_formula= par.index~
                            ...
                            ,
                            doFit = TRUE,silent=TRUE,
                            sim_rand =0,REML=FALSE,hypersd=1,map_hypers=c(TRUE,TRUE)
)
