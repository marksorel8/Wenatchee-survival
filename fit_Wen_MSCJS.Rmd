...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                            ...
                            ## to Bonneville
                           -1+ time1:LH + pc(0+time1|stream )+ pc(0+time1|stream:LH )+   pc(0+time1:sum_flow:LHsummer+time1:win_air:age_0|one) + diag(0+time1|mig_year)+
                            ## to McNary
                            time2+ pc(0+time2|LH) + diag(0+time2 |mig_year)+
                            ##to Bonneville
                            time3 + pc(0+time3|LH) + diag(0+time3|mig_year)+
                            ## SAR to Bonneville adult
                            time4 + pc(0+time4|LH) + diag(0+time4|mig_year)+ 
                            pc(0+ersstWAcoast.sum|one) + 
                            ## to McNary Adult
                            time5 + diag(0+time5|mig_year)+  pc(0+time5|stratum ) +                  
                            ## to Tumwater Adults
                            time6 + diag(0+time6|mig_year) + pc(0+time6|stratum )
                            ,
                            p_formula= par.index~
                            ## Lower Wenatchee Trap
                            -1+ time2:LH + pc(0+time2|stream )+ pc(0+time2|stream:LH )+ diag(0+time2|mig_year)+  
                            ## McNary Juveniles
                            time3+ pc(0+time3|LH) + diag(0+time3 |mig_year)+
                            # Bonneville Juvenile
                            time4+ pc(0+time4|LH) +pc(0+time4:McN_J:LH|one) + diag(0+time4 |mig_year) + 
                            # Bonn adult
                            time5 + diag(0+time5 |mig_year)+ pc(0+time5|stratum ) +
                            #McNary adult
                            time6 + diag(0+time6 |mig_year)+ pc(0+time6|stratum )
