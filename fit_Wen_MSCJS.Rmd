...
time1:streamWhite:LHsmolt+time1:streamWhite:LHfall+ 
                         ...
                         p_formula= par.index~
                           #fixed effects
                           -1+ time2++#time2:LHsmolt+time2:LHsummer+time2:streamWhite+#lower trap
                            time3+  #McNary
...
Phi.design.dat2 <- mscjs_dat$Phi.design.dat%>% mutate(phi_fit=mod_rep$phi,
                                            ...
                                            lcl_phi=pnorm(qnorm(.025,eta_phi,eta_phi_sd)),
                                            ucl_phi=pnorm(qnorm(.975,eta_phi,eta_phi_sd))) %>% 
...
p.design.dat <- mscjs_dat$p.design.dat %>% mutate(p_fit=mod_rep$p[-length(mod_rep$p)],
                                            ...
                                            lcl_p=pnorm(qnorm(.025,eta_p,eta_p_sd)),
                                            ucl_p=pnorm(qnorm(.975,eta_p,eta_p_sd)))
