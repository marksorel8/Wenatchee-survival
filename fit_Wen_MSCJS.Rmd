...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                            ...
                            pc(0+time1:sum_flow:LHsummer+time1:win_air:age_0|one) + pc(0+time1|mig_year)+
                            ## to McNary
                            time2+ pc(0+time2|LH) + pc(0+time2 |mig_year)+ 
                            ##to Bonneville
                            time3 + pc(0+time3|LH) + pc(0+time3|mig_year)+
                            ## SAR to Bonneville adult
                            time4 + pc(0+time4|LH) + pc(0+time4|mig_year)+ 
                            pc(0+time4:ersstWAcoast.sum|one) + 
                            ## to McNary Adult
                            ...
                            time3+ pc(0+time3|LH) + pc(0+time3 |mig_year)+
                            # Bonneville Juvenile
                            time4+ pc(0+time4|LH) +pc(0+time4:McN_J:LH|one) + pc(0+time4 |mig_year) + 
                            # Bonn adult
                            time5 + pc(0+time5 |mig_year)+ pc(0+time5|stratum ) +
                            #McNary adult
                            time6 + pc(0+time6 |mig_year)+ pc(0+time6|stratum )
