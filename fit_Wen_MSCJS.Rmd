...
Two of the most important drivers of population dynamics are stochasticity (Lande et al. 2003). Environmental stochasticity is the variability in environmental factors like weather that affect demographic rates, whereas demographic stochasticity refers to variability in demographic outcomes given vital rates. Both types of stochasticity can have strong effects on abundance and extinction risk and tend to be primary drivers of population dynamics for marine fish populations. 
...
test<-model.matrix(y~timej:LH + timej:stream+timej:stream:LH +timek:LH, data=test_data,contrasts.arg = list(LH=contr.sum(3),stream=contr.sum(3)))
...
dimnames(mscjs_fit$dat_TMB$Z_phi)
range(mscjs_fit$dat_TMB$Z_phi[,1:20])
dimnames(mscjs_fit$dat_TMB$X_phi)
...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         ...
                         phi_formula=par.index~
                            ...
                            ## to Bonneville
                            -1+  time1:LH +time1:stream +time1:LH:stream+ pc(0+time1|stream )+ pc(0+time1:stream|LH )+
                            ...
                            time4 + pc(0+time4|LH) + diag(0+time4:age_class |mig_year)+#diag(0+time4|mig_year)+ 
...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         ...
                         phi_formula=par.index~
                            ...
                            ## to McNary
                            time2+ time2:age_class +  #pc(0+time2:LHsummer|one)+
                            time2:RIS_temp_juv+time2:UC_spill_pct_juv +
                            diag(0+time2 |mig_year)+ #(0+time2:age_class |mig_year)+
                           
                            ##to Bonneville
                            time3 + time3:age_class + # pc(0+time3:LHsummer|one) +
                            diag(0+time3|mig_year)+#diag(0+time3:age_class |mig_year)+
                            time3:McN_temp+time3:MC_spill_pct_juv+
                           
                            ## SAR to Bonneville adult
                            time4 + time4:age_class + (0+time4:age_class |mig_year)+
                         ...
                         #survival
                           ...
                           ## McNary Juveniles
                            time3 + time3:age_class +
                            diag(0+time3 |mig_year)+ 
                            # time3:LWe_J:age_class+
                           # Bonneville Juvenile
                            time4 + time4:age_class +  
                         ...
                         ,
                          #maturation age                        
                            psi_formula= par.index~
                            -1+tostratum + tostratum:age_class + tostratum:stream +
                            (0+tostratum|mig_year)
                           ,
