...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                           ...
                           #fixed effect
                           -1+ time1:LH+time1:streamWhite +time2+time3 +time3:age_class+time4:age_class+time4 +time5+time6,
...
sum(test$phi[c(1,601)]*c((1-0.6818555),0.6818555))
test$phi[1801]
...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                           ...
                           #time2:streamNason+ #to mcnary
                           time2 + #to Bonneville
                           time3 + time3:LHsmolt + time3:LHsummer+#to Bonn adult
                           time4 +   #to McNary
                           time5 + #time6:stratum3 +    #to Tumwater
                           #random
                          (0+time1|mig_year) + #diag(0+time1:LH|mig_year) +
                           #(0+time2 |mig_year) +
                           (0+time3 |mig_year)# +
                         ...
                         p_formula= par.index~
                           ...
                           # time3:LWe_J +               #McNary
                            time3+ #Bonneville
                           time3:McN_J:age_0 +   #Bonneville
                           time4 +         # Bonn adult
                           time5 + #:stratum +         #McNary adult
                           #random
                           # lower trap
                           (0+time2+time3|mig_year)  # McNary
...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                           ...
                           #fixed effect
                           -1+ time1:LH+ time1:stream+time1:LWe_new+ # time1:streamWhite +#to lower wenatchee trap
...
mscjs_fit<-fit_wen_mscjs(x=mscjs_dat,
                         phi_formula=par.index~
                           ...
                           #fixed effect
<<<<<<< Updated upstream
                           -1+ time1+time1:LHsmolt+time1:LHsummer+ time1:streamWhite+ time1:streamNason+ time1:LWe_new+ 
...
>>>>>>> Stashed changes
                           ...
                           #random
<<<<<<< Updated upstream
                            diag(0+time1:LHfall+time1:LHsummer |mig_year) +
                           (0+time2 |mig_year) +
=======
...
>>>>>>> Stashed changes
                         ...
                         p_formula= par.index~
                           #fixed effects
                           -1+ time2+time2:LHsmolt+time2:LHsummer+ time2:LWe_new + #time2:streamChiwawa+#time2:streamWhite# lower trap
                            time3+     #McNary
                           # time3:LWe_J +               #McNary
                            time4+ #Bonneville
...
Psi.design.dat<-mscjs_dat$Psi.design.dat %>% filter(tostratum==2) %>% select(LH,mig_year,stream,McN_J) %>% cbind(mod_rep$psi) %>% filter(LH!="summer",stream=="Chiwawa",McN_J==0) %>% pivot_longer(`1`:`3`,names_to="years",values_to="prop") %>% mutate(LH=ifelse(LH=="fall","Subyearling","Smolt"))
